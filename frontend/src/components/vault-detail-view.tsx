    ...
    <>
      ...
      {live && (
        <div className="empty" style={{ marginBottom: 20 }}>
          This vault isn&apos;t indexed by Argus — showing a live on-chain read (totalAssets/totalSupply via RPC) instead of Subgraph history. No share-price history or alerts are available for it.
        </div>
      )}
